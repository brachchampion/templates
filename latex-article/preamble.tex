...
\definecolor{dark-alice}{HTML}{107896}
...
\hypersetup{
    colorlinks= true,
    citecolor= dark-alice,
    linkcolor= dark-alice,
    filecolor= dark-alice,      
    urlcolor= dark-alice,
}
...
\postauthor{\end{center}\vspace{-7.5mm}}

% date
\predate{\begin{center}\scshape\color{asher}}
\postdate{\end{center}\vspace{-5mm}}

% Abstract
\renewenvironment{abstract}
 {\noindent\noindent\textsc{Abstract: }\rule{.88\linewidth}{.5pt}\noindent}
...
\captionsetup[table]{format=plain, labelsep=threedash, font={sc}}
\captionsetup[figure]{format=plain, labelsep=threedash, font={sc}}
