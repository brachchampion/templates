...
\setbeamercolor{bibliography item}{fg = asher}
\setbeamercolor{bibliography entry author}{fg = asher}
\setbeamercolor{bibliography entry title}{fg = asher}
\setbeamercolor{bibliography entry location}{fg = asher}
\setbeamercolor{bibliography entry note}{fg = asher}
